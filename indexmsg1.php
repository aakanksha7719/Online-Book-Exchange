...
<li>  
<a href="http://localhost/project/indexmsg1.php"> | User Messages |</a>  
</li> 
<li>  
<a href="http://localhost/project/indexuser1.php"> | User Information |</a>  
</li> 
<li>  
<a href="http://localhost/project/indexbook1.php"> | Book Request |</a>  
</li> 
<li>  
...
$result = mysqli_query($mysqli, "SELECT * FROM message ORDER BY id DESC"); // using mysqli_query instead
?>
...
<body><br><br><br><br>
<h2><b><u>USER MESSAGES</u></b><br>
<br><br>
<div style="float:left;">
<a href="http://localhost/project/msg_to_user1.html">+Add New Data</a><br/><br/>
 </div><br><br>
 ...
 <CENTER>
	...
	while($res = mysqli_fetch_array($result)) { 		
		...
		echo "<td><a href=\"editmsg.php?id=$res[id]\">Edit</a> | <a href=\"deletemsg.php?id=$res[id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";		
	}
	?>
	</table>
	</CENTER></h2>
